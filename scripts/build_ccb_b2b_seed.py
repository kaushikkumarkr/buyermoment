...
SCENARIOS = [
    ...
    ("CRM", "A 120-person services firm is replacing its CRM after a failed rollout and needs SSO plus Salesforce migration support by September.", "comparison", "high", "actionable", "revenue operations", "mid-market", ["SSO", "Salesforce migration"], "by September"),
    ("CRM", "I am collecting CRM feature lists for a university procurement class and cannot approve a purchase.", "informational", "low", "not_actionable", "student", "unknown", [], "none"),
    ("Sales", "Our account executives lose time updating opportunities and leadership approved a sales-forecasting evaluation this month.", "consideration", "high", "actionable", "VP Sales", "enterprise", ["forecasting"], "this month"),
    ("Sales", "What are common sales-forecasting methods? I am writing a non-commercial article.", "informational", "low", "not_actionable", "writer", "unknown", [], "none"),
    ("Marketing Automation", "We need lead scoring that syncs with our CRM and procurement wants a shortlist within 60 days.", "comparison", "high", "actionable", "demand generation lead", "mid-market", ["CRM", "lead scoring"], "60 days"),
    ("Marketing Automation", "Our existing automation is broken; how do I troubleshoot a failed email journey?", "informational", "low", "not_actionable", "marketing administrator", "unknown", [], "none"),
    ("Analytics / BI", "The CFO wants self-serve dashboards for three business units and requires row-level security before renewal.", "consideration", "high", "actionable", "finance executive", "enterprise", ["row-level security"], "before renewal"),
    ("Analytics / BI", "Compare dashboard chart types for a data-visualization workshop.", "exploration", "low", "not_actionable", "trainer", "unknown", [], "none"),
    ("Accounting / Finance", "Our startup has outgrown spreadsheets and needs accounts payable automation connected to NetSuite this quarter.", "consideration", "high", "actionable", "finance operations", "small business", ["NetSuite", "accounts payable"], "this quarter"),
    ("Accounting / Finance", "I am researching the history of invoice automation for a newsletter.", "informational", "low", "not_actionable", "researcher", "unknown", [], "none"),
    ("Procurement", "We need supplier intake with approval routing and audit logs for a regulated business; security review starts next month.", "consideration", "high", "actionable", "procurement director", "enterprise", ["audit logs", "approval routing"], "next month"),
    ("Procurement", "Our client may need intake software someday, but I am only gathering broad market information.", "exploration", "medium", "uncertain", "consultant", "unknown", [], "someday"),
    ("Project Management", "Engineering leadership wants a Jira alternative with time tracking and a pilot for two teams next quarter.", "comparison", "high", "actionable", "engineering director", "mid-market", ["Jira", "time tracking"], "next quarter"),
    ("Project Management", "How did agile project-management tools become popular? This is for an exam.", "informational", "none", "not_actionable", "student", "unknown", [], "none"),
    ("DevOps", "We are moving from Jenkins and need hosted CI with audit logs and procurement approval before the migration window.", "consideration", "high", "actionable", "platform lead", "enterprise", ["Jenkins migration", "audit logs"], "before migration"),
    ("DevOps", "I am comparing build systems for a technical conference talk, not selecting a vendor.", "comparison", "low", "not_actionable", "developer advocate", "unknown", [], "none"),
    ("Cybersecurity", "Our security team is shortlisting cloud posture tools with EU data residency and an assessment this quarter.", "comparison", "high", "actionable", "security architect", "enterprise", ["EU data residency"], "this quarter"),
    ("Cybersecurity", "I already use this security product; how do I rotate an integration token?", "informational", "low", "not_actionable", "security administrator", "unknown", [], "none"),
    ("HR / Payroll", "We are consolidating HR systems after an acquisition and need payroll integration plus implementation help by year end.", "consideration", "high", "actionable", "HR operations", "mid-market", ["payroll integration"], "by year end"),
    ("HR / Payroll", "What should a market report include when comparing payroll vendors?", "informational", "low", "not_actionable", "analyst", "unknown", [], "none"),
    ("Customer Support", "We need a knowledge base and AI-assisted triage with data retention controls before the next support hiring wave.", "comparison", "high", "actionable", "customer experience leader", "mid-market", ["knowledge base", "data retention"], "before next hiring wave"),
    ("Customer Support", "I am studying support automation for a graduate paper and have no buying project.", "informational", "none", "not_actionable", "student", "unknown", [], "none"),
]
